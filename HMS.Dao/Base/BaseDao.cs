...
namespace Dao.HMS.Base
{
    ...
    public class BaseDao<TEntityT, TIdT> : IBaseDao<TEntityT, TIdT> where TEntityT : class
    {
        ...
        public virtual void Save(TEntityT data)
        {
            ...
            entity.CreateBy = entity.CreateBy != null ? entity.CreateBy : HttpContext.Current.User.Identity.GetUserId();
        ...
        public void Update(TEntityT data)
        {
            ...
            {
                entity.ModifyBy = HttpContext.Current.User.Identity.GetUserId();
